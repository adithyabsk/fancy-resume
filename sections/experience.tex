...
\headedsection{\href{https://georgianpartners.com/}{Synthego | 8VC Fellow}}
...
{%
	...
	{%
		\bodytext{%
			Matched with Synthego through the \eightvc{competitive (30/1000) fellowship} program. Was a member of the team develops the core software that operationalizes CRISPR advances.
			\begin{tightemize}
				\item Operated in a full stack capacity to deploy patches to a Django and React stack delivering 9 new product features.
				\item Modernized a multiple large (10,000 lines of code) codebases to use Python best practices, including linting (black, flake8) and type checking (mypy). Integrated best practices into the continuous integration pipeline.
				\item Prototyped and implemented automatic internal Django API documentation compliant with OpenAPI v3. Deployed two API documentation pages and one developer documentation page using Sphinx.
			\end{tightemize}
		}
	}
}

...
{%
	...
	{%
		\bodytext{%
			...
			\begin{tightemize}
				\item Operated in a full-stack capacity to deploy production-ready features to a Django and React stack delivering 9 new product features.
				\item Modernized a multiple large (10,000 lines of code) codebases to use Python best practices in continuous integration: linting (black, flake8) and type checking (mypy).
				\item Prototyped and implemented automatic Django API documentation compliant with OpenAPI v3. Deployed API and developer documentation using Swagger and Sphinx.
			\end{tightemize}
		}
	}
}

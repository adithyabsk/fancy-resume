...
{\headedsubsection{President, Chair}
	...
	{%
		\bodytext{%
			...
			\begin{tightemize}
				\item Increase student membership by 20\% by conducting technical talks of interest to members.
...
{\headedsubsection{President}
	...
	{%
		\bodytext{%
			...
			\begin{tightemize}
				\item Assisted in the organization of a special event with FIRST's founder, Dean Kamen, at NC State.
				\item Enabled students to volunteer for over 1,000 hours across local FIRST robotics events in dire need of help.
			\end{tightemize}
		}
	}
}
...
{%
	...
	{%
		\bodytext{%
			Responsible for assisting the president of the organization during day-to-day operations of the largest honors society at NC State.
			\begin{tightemize}

	...
	{%
		\bodytext{%
			...
			\begin{tightemize}
				...
				\item Led the team to a world championship quarterfinal berth and open sourced our code and work to the community.
			\end{tightemize}
		}
	}
}
...
{%
	...
	{%
		\bodytext{%
			...
			\begin{tightemize}
				\item Developed an Energy Star portfolio metric analysis report using the school's utility footprint.
